...
export const courses: readonly Course[] = [
  {
    ...
    level: "početni",
    priceRsd: 0,
    image: "/images/academy/barrier-reset.png",
    accent: "#d9ef72",
    featured: true,
        ...
        lessons: [
          {
            ...
            durationMinutes: 12,
            preview: false,
            image: "/images/academy/retinal.png",
  ...
  },
  {
    ...
    modules: [{ id: "retinal-start", title: "01 · Bezbedan početak", summary: "Od nule do održivog ritma.", lessons: [
      { id: "lesson-retinal-map", slug: "retinal-mapa", title: "Retinoidna mapa", summary: "Retinol, retinal i receptorske opcije — bez konfuzije.", durationMinutes: 11, preview: true, image: "/images/academy/retinal.png", productIds: ["al-retinal-emulsion", "tc-ceramide-cream"], chapters: [{ time: "00:00", label: "Porodica retinoida" }, { time: "04:00", label: "Kome odgovara" }, { time: "08:20", label: "Kontraindikacije" }], checklist: ["Proveri trudnoću/dojenje", "Stabilizuj osnovnu rutinu", "Izaberi dve večeri nedeljno"], transcript: ["Retinal je moćan alat, ali nije obavezna stanica svake rutine.", "U trudnoći i tokom dojenja retinoidi se ne koriste." ] },
